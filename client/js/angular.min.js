...
(function(N, Y, q) {
 ...
 function ba(b, a, c) {
  var d = b[Ba],
   d = Ca[d || -1];
  if (y(c)) d || (b[Ba] = d = ++oc, d = Ca[d] = {}), d[a] = c;
  else return d && d[a]
 }
 ...
 function vc(b, a, c, d) {
  ...
  f.url = function(a,
   ...
   if (a) {
    if (C != a) return C = a,
     d.history ? b ? k.replaceState(null,
      "",
      a) : (k.pushState(null, "", a), z.attr("href", z.attr("href"))) : b ? i.replace(a) : i.href = a, f
   }
  ...
  f.onUrlChange = function(a) {
   J || (d.history && u(b).bind("popstate",
     h),
    d.hashchange ? u(b).bind("hashchange",
     h) : f.addPollFn(h), J = !0);
   W.push(a);
   return a
  };
  ...
  f.cookies = function(a,
   ...
   var d,
    ...
    i;
   if (a)
    if (b === q) j.cookie = escape(a) + "=;path=" + Q + ";expires=Thu, 01 Jan 1970 00:00:00 GMT";
    else {
     if (B(b)) d = (j.cookie = escape(a) + "=" + escape(b) + ";path=" + Q).length + 1,
...
function(b,
 ...
 function P(a,
  ...
  return function(b,
   ...
   for (var e = c ? va.clone.call(a) : a, g = 0, i = e.length; g < i; g++) {
    var h = e[g];
    (h.nodeType == 1 || h.nodeType == 9) && e.eq(g).data("$scope",
     b)
   }
   C(e,
    "ng-scope");
 ...
 function z(a,
  ...
  function e(a,
   ...
   t = l = 0;
   for (m = g.length; l < m; t++) j = s[t],
    c = g[l++],
    h = g[l++],
    c ? (c.scope ? (k = a.$new(L(c.scope)),
      u(j).data("$scope", k)) : k = a,
     (o = c.transclude) || !i && b ? c(h,
      k,
      j,
      d,
      function(b) {
  ...
  for (var g = [],
   ...
   h = (i = i.length ? J(i,
    ...
    h,
    b,
    c) : null) && i.terminal || !a[k].childNodes || !a[k].childNodes.length ? null : z(a[k].childNodes,
    i ? i.transclude : b),
   g.push(i),
   g.push(h),
   j = j || i || h;
  ...
  switch (a.nodeType) {
   case 1:
    ...
    for (var o = 0,
      m = h && h.length; o < m; o++)
     if (j = h[o],
      j.specified) k = j.name,
      l = ea(k.toLowerCase()),
      g[l] = k,
      c[l] = j = O(Z && k == "href" ? decodeURIComponent(a.getAttribute(k, 2)) : j.value), Ab(a, l) && (c[l] = !0), S(a, b, j, l), r(b, l, "A", i);
    a = a.className;
    if (B(a) && a !== "")
     for (; h = e.exec(a);) l = ea(h[2]),
      r(b,
       l,
       "C",
       i) && (c[l] = O(h[3])),
   ...
   case 8:
    try {
     if (h = d.exec(a.nodeValue)) l = ea(h[1]),
      r(b,
       l,
       "M",
       i) && (c[l] = O(h[2]))
 ...
 function J(a,
  ...
  function i(a,
   b) {
   if (a) a.require = r.require,
    m.push(a);
   if (b) b.require = r.require,
    s.push(b)
  }
  ...
  for (var l = -Number.MAX_VALUE,
   ...
   if (X = r.scope) ua("isolated scope",
     J,
     r,
     D),
    L(X) && (C(D,
    ...
    p = p || r;
   F = r.name;
   if (X = r.controller) y = y || {},
    ua("'" + F + "' controller",
     y[F],
     r,
     D),
    y[F] = r;
   if (X = r.transclude) ua("transclusion",
     ka,
     r,
     D),
    ka = r,
 ...
 function r(d,
  ...
  if (a.hasOwnProperty(e))
   for (var l,
     e = b.get(e + c),
     o = 0,
     m = e.length; o < m; o++) try {
    if (l = e[o],
     (g === q || g > l.priority) && l.restrict.indexOf(i) != -1) d.push(l),
     h = !0
   }
  catch (t) {
   k(t)
 ...
 function $(a,
  ...
  n(b,
   function(b,
    i) {
    i == "class" ? (C(e, b),
     a["class"] = (a["class"] ? a["class"] + " " : "") + b) : i == "style" ? e.attr("style", e.attr("style") + ";" + b) : i.charAt(0) != "$" && !a.hasOwnProperty(i) && (a[i] = b, d[i] = c[i])
   }
  )
 }
 ...
 ia.prototype = {
  ...
  $set: function(a,
   ...
   if (gb(this.$$element[0]) === "A" && a === "href") D.setAttribute("href",
     b),
    e = D.href,
  ...
  function(c) {
   function d(d,
    ...
    for (var j,
      ...
      o = []; k < l;)(j = d.indexOf(b,
     k)) != -1 && (i = d.indexOf(a,
     j + e)) != -1 ? (k != j && m.push(d.substring(k, j)),
     m.push(k = c(t = d.substring(j + e, i))),
     k.exp = t,
     k = i + g,
     t = !0) : (k != l && m.push(d.substring(k)), k = l);
    if (!(l = m.length)) m.push(""),
     l = 1;
    if (!f || t) return o.length = l,
     k = function(a) {
      for (var b = 0,
        c = l,
        d; b < c; b++) {
       if (typeof(d = m[b]) == "function") d = d(a),
...
function Ha(b,
 ...
 this.$$compose = function() {
  ...
  this.$$absUrl = la(this.$$protocol,
   this.$$host,
   this.$$port) + d + (this.$$url ? "#" + a + this.$$url : "")
 };
 this.$$rewriteAppUrl = function(a) {
  if (a.indexOf(c) == 0) return a
 };
  ...
  function(c,
   ...
   a ? (j = d.baseHref() || "/",
    ...
    f = e.history ? new ib(Fc(k,
     ...
     b,
     m,
     j.substr(i.length + 1))) : (m = la(m.protocol,
     m.host,
     m.port) + (m.path || "") + (m.search ? "?" + m.search : "") + "#" + b + "/",
    f = new Ha(k,
     b,
     m));
   g.bind("click",
    ...
    if (!l || a != f.absUrl()) l++,
     c.$evalAsync(function() {
      c.$broadcast("$locationChangeStart",
       f.absUrl(),
       a).defaultPrevented ? f.$$parse(a) : (d.url(f.absUrl(), b), h(a))
     });
    f.$$replace = !1;
    return l
   });
...
function Kc(b,
 ...
 function j(a,
  ...
  d) {
  d = d || o;
  throw Error("Lexer Error: " + a + " at column" + (y(c) ? "s " + c + "-" + o + " [" + b.substring(c,
   d) + "]" : " " + d) + " in expression [" + b + "].");
 }
 ...
 function m(a) {
  ...
  for (var d = "",
   ...
   var i = b.charAt(o);
   e += i;
   if (f) i == "u" ? (i = b.substring(o + 1,
      o + 5),
     i.match(/[\da-f] {
      4
     }
     /i)||j("Invalid unicode escape [\\u"+i+"]"),
     o += 4,
     d += String.fromCharCode(parseInt(i,
      16))) : (f = Lc[i],
     d += f ? f : i),
    f = !1;
   else if (i == "\\") f = !0;
 ...
 for (var l = [],
  ...
  if (c("\"'")) m(s);
   ...
   if (k(),
    "{,".indexOf(P) != -1 && p[0] == "{" && (t = l[l.length - 1])) t.json = t.text.indexOf(".") == -1
  }
  else if (c("(){}[].,;:")) l.push({
    index: o,
    text: s,
   ...
   W ? (l.push({
    ...
    o += 1) : j("Unexpected next character ",
    o,
    o + 1)
  }
  P = s
...
function Mc(b,
 ...
 function f(b,
  ...
  return (b = h(b,
   c,
   d,
   f)) ? (a && !b.json && e("is not valid json",
    b),
   Q.shift(),
   b) : !1
 }
 ...
 function j(a) {
  f(a) || e("is unexpected, expecting [" + a + "]",
   h())
 }
 ...
 function m() {
  for (var a = [];;)
   if (Q.length > 0 && !h("}",
     ")",
     ";",
     "]") && a.push(x()), !f(";")) return a.length == 1 ? a[0] : function(b,
    c) {
    for (var d,
      e = 0; e < a.length; e++) {
     var f = a[e];
 ...
 var r = I(0),
  ...
  F = function() {
   var a = t(),
    c,
    d;
   return (d = f("=")) ? (a.assign || e("implies assignment but [" + b.substring(0,
      d.index) + "] can not be assigned to",
     d),
    c = t(),
    function(b,
     d) {
  ...
  y = function(a,
   ...
   return function(d,
    ...
    for (var f = [],
      i = b ? b(d,
       e) : d, g = 0; g < c.length; g++) f.push(c[g](d,
     e));
    g = a(d,
     e) || w;
    return g.apply ? g.apply(i,
     f) : g(f[0], f[1], f[2], f[3], f[4])
   }
  },
  u = function(a) {
   var b = f().text,
 ...
 a ? (F = t,
  ...
  $ = z()) : $ = m();
 Q.length !== 0 && e("is an unexpected token",
  Q[0]);
 return $
}
 ...
 this.$get = ["$rootScope",
  ...
  function i() {
   ...
   if (b && i && b.$$route === i.$$route && ga(b.pathParams,
     i.pathParams) && !b.reloadOnSearch && !l) i.params = b.params,
    V(i.params,
     d),
    a.$broadcast("$routeUpdate",
     i);
   else if (b || i) l = !1,
    a.$broadcast("$routeChangeStart",
     b,
     i),
    (t.current = b) && b.redirectTo && (B(b.redirectTo) ? c.path(m(b.redirectTo,
     ...
     if (b) {
      ...
      if (b == t.current) {
       if (b) b.locals = c,
        V(b.params,
         d);
       a.$broadcast("$routeChangeSuccess",
        b,
        i)
      }
     },
      ...
      do {
       ...
       if (h = n.$$watchers)
        for (o = h.length; o--;) try {
         if (a = h[o],
          (d = a.get(n)) !== (e = a.last) && !(a.eq ? ga(d,
           e) : typeof d == "number" && typeof e == "number" && isNaN(d) && isNaN(e))) p = !0, a.last = a.eq ? V(d) : d, a.fn(d, e === f ? d : e, n), s < 5 && (z = 4 - s, C[z] || (C[z] = []), q = H(a.exp) ? "fn: " + (a.exp.name || a.exp.toString()) : a.exp, q += "; newVal: " + da(d) + "; oldVal: " + da(e), C[z].push(q))
        }
       catch (r) {
        c(r)
       }
...
this.$get = ["$httpBackend",
 ...
 function(a,
  ...
  function l(b,
   ...
   function h() {
    var a = Aa(m.pendingRequests,
     b);
    a !== -1 && m.pendingRequests.splice(a,
     1)
   }
   var k = i.defer(),
    l = k.promise,
...
function Wb(b,
 ...
 if (!i) {
  ...
  x(e) && (e = Math.min(Math.max(a.minFrac,
    h),
   a.maxFrac));
  var h = Math.pow(10,
    e),
   ...
   m = a.gSize;
  if (h.length >= k + m)
   for (var i = h.length - k,
     l = 0; l < i; l++)(i - l) % m === 0 && l !== 0 && (f += c),
    f += h.charAt(l);
  for (l = i; l < h.length; l++)(h.length - l) % k === 0 && l !== 0 && (f += c),
   f += h.charAt(l);
  for (; b.length < e;) b += "0";
  e && e !== "0" && (f += d + b.substr(0,
   e))
 }
...
function Tb(b) {
 function a(a) {
  ...
  if (b = a.match(c)) {
   ...
   b[9] && (g = G(b[9] + b[10]),
    h = G(b[9] + b[11]));
   a.setUTCFullYear(G(b[1]),
    G(b[2]) - 1,
    G(b[3]));
   a.setUTCHours(G(b[4] || 0) - g,
    G(b[5] || 0) - h,
    G(b[6] || 0),
    G(b[7] || 0))
  }
...
return function(c,
 ...
 Ra(c) && (c = new Date(c));
 if (!oa(c)) return c;
 for (; e;)(j = gd.exec(e)) ? (h = h.concat(ha.call(j,
   1)),
...
function Pa(b,
 ...
 ;
 if (e.hasEvent("input")) a.bind("input",
  h);
 else {
  var f;
  a.bind("keydown",
 ...
 var j = c.ngPattern,
  i = function(a,
   ...
   return U(b) || a.test(b) ? (d.$setValidity("pattern", !0),
    b) : (d.$setValidity("pattern", !1), q)
  }

 ;
 j && (j.match(/^\/(.*)\/$/) ? (j = RegExp(j.substr(1,
    j.length - 2)),
   e = function(a) {
    return i(j,
     a)
...
var kc = /[A-Z]/g,
 ...
 oc = 1,
 $b = N.document.addEventListener ? function(b,
  a,
  c) {
 ...
 eb = N.document.removeEventListener ? function(b,
  a,
  c) {
...
var Bb = {};
n("input,select,option,textarea,button,form".split(","),
 function(b) {
  Bb[ma(b)] = !0
 }
);
n({
  ...
  attr: function(b,
   ...
   if (Fa[d])
    ...
    else return b[a] || (b.attributes.getNamedItem(a) || w).specified ? d : q;
   else if (y(c)) b.setAttribute(a,
    c);
  ...
  html: function(b,
   ...
   for (var c = 0,
     d = b.childNodes; c < d.length; c++) sa(d[c]);
   b.innerHTML = a
  }
 },
 function(b,
  ...
  K.prototype[a] = function(a,
   ...
   if ((b.length == 2 && b !== Da && b !== zb ? a : d) === q)
    ...
    for (e = 0; e < this.length; e++) b(this[e],
     a,
     d);
    return this
   }
...
n({
 ...
 function(a,
  ...
  K.prototype[c] = function(c,
   e) {
   for (var g,
     h = 0; h < this.length; h++) g == q ? (g = a(this[h],
     c,
     e),
...
fb.prototype = {
 ...
 shift: function(a) {
  var c = this[a = fa(a)];
  if (c) return c.length == 1 ? (delete this[a],
   c[0]) : c.shift()
 }
...
w * @) ? (\{ ?
 ...
 }; Ha.prototype = za(ib.prototype); Jb.prototype = za(Ha.prototype);
 var Ja = {
   "null": function() {
    return null
   }
 ...
 var Xb = ".",
  ...
  fd = /^\d+$/; Tb.$inject = ["$locale"];
 var dd = I(A),
  ed = I(ma); Vb.$inject = ["$parse"];
 var jd = I({
   restrict: "E",
   compile: function(a,
    c) {
...
w * @) ? (\S + )(: [0 - 9] + ) ? (\/|\/([\w#!:.?+=&%@!\-\/]))?$/,
 nd = /^[A-Za-z0-9._%+-]+@[A-Za-z0-9.-]+\.[A-Za-z] {
 2,
 4
}
$ / ,
  ...
  number: function(a,
   ...
   e.$parsers.push(function(a) {
    ...
    return c || od.test(a) ? (e.$setValidity("number", !0),
     a === "" ? null : c ? a : parseFloat(a)) : (e.$setValidity("number", !1), q)
   });
 ...
 pd = ["$scope",
  ...
  function(a,
   ...
   this.$setViewValue = function(d) {
    ...
    if (this.$modelValue !== d) this.$modelValue = d,
     j(a,
      d),
     n(this.$viewChangeListeners,
      function(a) {
       try {
        a()
       }
   ...
   a.$watch(function() {
     ...
     if (l.$modelValue !== c) {
      ...
      if (l.$viewValue !== c) l.$viewValue = c,
       l.$render()
     }
    }
 ...
 ud = function() {
  return {
   ...
   compile: function(a,
    c) {
    return td.test(c.ngValue) ? function(a,
      c,
      g) {
      g.$set("value",
       a.$eval(g.ngValue))
...
var Ed = R(function(a,
 ...
 Sd = ["$templateCache",
  function(a) {
   return {
    ...
    compile: function(c,
     d) {
     d.type == "text/ng-template" && a.put(d.id,
      c[0].text)
    }
   }
  }
 ...
 Ud = ["$compile",
  ...
  function(a,
   c) {
   var d = /^\s*(.*?)(?:\s+as\s+(.*?))?(?:\s+group\s+by\s+(.*))?\s+for\s+(?:([\$\w][\$\w\d]*)|(?:\(\s*([\$\w][\$\w\d]*)\s*,\
   s * ([\$\ w][\$\ w\ d] * )\ s * \)))\ s + in \s + (.*) $ / ,
 e = {
  $setViewValue: w
 };
   ...
   function h() {
    ...
    for (x = c.length; w < x; w++) {
     ...
     if (r.length <= w) p = {
      ...
      p = u[0],
      p.label != d) p.element.attr("label",
      p.label = d);
     B = null;
     A = 0;
     for (y = i.length; A < y; A++)
      ...
      else d.id === "" && s ? E = s : (E = C.clone()).val(d.id).attr("selected",
        d.selected).text(d.label),
       u.push({
        element: E,
        label: d.label,
        id: d.id,
      ...
      if (o) {
       ...
       for (s = r.length; m < s; m++) {
        ...
        for (p = a.length; j < p; j++)
         if ((h = a[j].element)[0].selected) h = h.val(),
          l && (d[l] = h),
          d[k] = c[h],
          i.push(n(e,
           d))
